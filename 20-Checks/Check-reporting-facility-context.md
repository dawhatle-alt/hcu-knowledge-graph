---
type: check
check_name: reporting-facility-context
product: EM
status: skeleton
tags:
  - hcu
...
**Config source:** `/ctrlmdata/ctmem/ctm_em/services/context/reporting-facility.yml`
...
**Components:** [[Component-Reporting-Facility]]
